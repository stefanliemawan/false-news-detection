...
def politiModel(x1_shape, x2_shape, x3_shape, statement_vocab, metadata_vocab, n_output1, n_output2, emb_matrix):
    # FIND HIGHER ACCURACY, experiment with kernel regularizer value
    # low subjectivity rating
    cnn_filter = 128
    ...
    lstm1_1 = LSTM(128, kernel_regularizer=regularizers.l2(3),
                   name="lstm1_1")(emb1_1)
    drop1_1 = Dropout(0.5, name="dropout_1_1")(lstm1_1)
    ...
    lstm2_1 = LSTM(64, kernel_regularizer=regularizers.l2(3),
                   name="lstm2_1")(emb2_1)
    drop2_1 = Dropout(0.5, name="dropout_2_1")(lstm2_1)

    x3 = Input(shape=(x3_shape[1], ), name="input_3")
    # lstm3_1 = LSTM(256, name="lstm3_1")(x3)
    dense3_1 = Dense(64, activation="relu", name="dense3_1")(x3)
    drop3_1 = Dropout(0.5, name="dropout_3_1")(dense3_1)
    # dense3_2 = Dense(128, activation="relu")(dense3_1)

    # x23 = concatenate([lstm2_1, dense3_1])
    # dense = Dense(256, activation="relu")(x23)
    ...
    # y2 = Dense(n_output2, activation="linear", name="output_2")(x)
    model = keras.Model(inputs=[x1, x2, x3], outputs=y1)
    return model
